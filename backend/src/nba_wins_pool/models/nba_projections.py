...
class NBAProjections(SQLModel, table=True):
    ...
    bpi: Optional[float] = Field(default=None)
    playoff_bpi: Optional[float] = Field(default=None)
    ...
    reach_conf_semis_prob: Optional[float] = Field(default=None)
    reach_conf_finals_prob: Optional[float] = Field(default=None)
    ...
    reach_conf_semis_odds: Optional[int] = Field(default=None)

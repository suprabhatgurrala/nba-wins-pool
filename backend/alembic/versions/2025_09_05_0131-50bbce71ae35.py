...
Revision ID: 50bbce71ae35
Revises: 
Create Date: 2025-09-05 01:31:48.140934
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['closed_by'], ['member.id'], ),
    sa.ForeignKeyConstraint(['nominator_id'], ['member.id'], ),
    sa.ForeignKeyConstraint(['team_id'], ['team.id'], ),
    sa.ForeignKeyConstraint(['winning_bidder_id'], ['member.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['bidder_id'], ['member.id'], ),
    sa.ForeignKeyConstraint(['lot_id'], ['auctionlot.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
